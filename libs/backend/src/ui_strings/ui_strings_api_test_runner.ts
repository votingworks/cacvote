...
export function runUiStringApiTests(params: {
  ...
  test('getUiStrings', () => {
    ...
    expect(api.getUiStrings({ languageCode: 'es' })).toBeNull();
  ...
  test('getUiStringAudioIds', () => {
    ...
    expect(api.getUiStringAudioIds({ languageCode: 'es' })).toBeNull();
  });

  test('getAudioClipsBase64', () => {
    store.addLanguage('es');
    ...
    const clips: UiStringAudioClips = [
      { dataBase64: 'ABC==', id: 'es1', languageCode: 'es' },
      { dataBase64: 'BAC==', id: 'es2', languageCode: 'es' },
      { dataBase64: 'CAB==', id: 'es3', languageCode: 'es' },
    ];
